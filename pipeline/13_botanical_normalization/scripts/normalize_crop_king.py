...
df = pd.read_csv('../input/remove/botanical_crop_king.csv', encoding='latin-1')
print(f"Loaded {len(df)} Crop King strains")
...
df.to_csv('../output/botanical_crop_king_normalized.csv', index=False, encoding='latin-1')
...
print("\nCrop King normalized successfully")
