...
df = pd.read_csv('../input/remove/botanical_barneys_farm.csv', encoding='latin-1')
print(f"Loaded {len(df)} Barneys Farm strains")
...
df.to_csv('../output/botanical_barneys_farm_normalized.csv', index=False, encoding='latin-1')
...
print("\nBarneys Farm normalized successfully")
