...
df = pd.read_csv('../input/remove/botanical_amsterdam.csv', encoding='latin-1')
print(f"Loaded {len(df)} Amsterdam strains")
...
df.to_csv('../output/botanical_amsterdam_normalized.csv', index=False, encoding='latin-1')
...
print("\nAmsterdam normalized successfully")
