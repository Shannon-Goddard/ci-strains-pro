...
df = pd.read_csv('../input/remove/botanical_herbies.csv', encoding='latin-1')
print(f"Loaded {len(df)} Herbies strains")
...
df.to_csv('../output/botanical_herbies_normalized.csv', index=False, encoding='latin-1')
...
print("\nHerbies normalized successfully")
