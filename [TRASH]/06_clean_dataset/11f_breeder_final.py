"""
Step 11F: Final Breeder Cleanup
Cleans Seedsman breeders and removes non-cannabis products.
Logic designed by Amazon Q, verified by Shannon Goddard.
"""
import pandas as pd

df = pd.read_csv('../../cleaning_csv/11e_breeder_merged.csv', encoding='latin-1', low_memory=False)
...
non_cannabis_urls = [
    ...
    'https://exoticgenetix.com/product/splitz-strain-t-shirt/',
    'https://exoticgenetix.com/product/neon-nights-gen/',
]
initial = len(df)
...
df.to_csv('../../cleaning_csv/11f_breeder_final.csv', index=False, encoding='utf-8')
df.head(100).to_csv('output/11f_breeder_final_sample.csv', index=False, encoding='utf-8')
print(f"\nOutput: {len(df)} rows -> ../../cleaning_csv/11f_breeder_final.csv")
