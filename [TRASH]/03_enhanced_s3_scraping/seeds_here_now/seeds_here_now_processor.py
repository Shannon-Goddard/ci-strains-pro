...
def extract_seeds_here_now_data(html_content, url):
...
def main():
    ...
    for page in paginator.paginate(Bucket='ci-strains-html-archive', Prefix='metadata/'):
        ...
        for obj in page['Contents']:
            try:
                ...
                if 'seedsherenow.com' in url.lower():
                    ...
                    strain_data = extract_seeds_here_now_data(html_content, url)
    ...
    if all_data:
        ...
        df.to_csv('seeds_here_now_complete.csv', index=False, encoding='utf-8')
        print(f"Seeds Here Now: {len(all_data)} strains extracted")
    else:
        print("No Seeds Here Now strains found")
